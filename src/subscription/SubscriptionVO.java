...
public class SubscriptionVO extends VOBase implements Runnable{
	...
	public void setContactType(ContactTypeVO type)
	{
		this.createFacet(default_facet[1], (VOBase)type);
	}
	public void setContactInfo(VOBase info)
	{
		this.createFacet(default_facet[2], info);
	}
